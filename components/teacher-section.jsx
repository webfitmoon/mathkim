...
export default function TeacherSection() {
  return <section className="section" id="teacher"><div className="wrap">
    ...
    <div className="teacher-profile">
      <figure className="teacher-photo"><img src="/media/kim-sungmin-photo-placeholder.svg" alt="김성민 강사 프로필 사진이 들어갈 목업 자리" width="800" height="1000" loading="lazy" /><figcaption>김성민 강사 · 프로필 사진 삽입 예정</figcaption></figure>
